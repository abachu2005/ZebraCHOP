...
def coordToFasta(regions, fasta_file, outputDir, targetSize, evalAndPrintFunc, nonOver, indexDir, genome, strand, ext):
    ...
    for region in regions:
        ...
        def check_permissions(file_path, mode):
            """ Check if the current user has the specified permissions for the file_path """
            if mode == 'read':
        ...
        # Paths to check
        twobit_file_path = os.path.join(indexDir, genome + ".2bit")
        output_error_file_path = os.path.join(outputDir, 'twoBitToFa.err')
...
def main():
    ...
    parser.add_argument("-TUP", "--targetUpstreamPromoter", default=0, type=int, help="how many bp to target upstream of TSS")
    parser.add_argument("-G", "--genome", default="danRer11", metavar="GENOME", help="The genome to search.")
    ...
    parser.add_argument("-t", "--target", default="CODING", dest="targetRegion", help="Target the whole gene CODING/WHOLE/UTR5/UTDPR3/SPLICE. Default is CODING.")
    ...
    parser.add_argument("-f", "--fivePrimeEnd", default="GN", type=str, help="Specifies the requirement of the two nucleotides 5' end of the CRISPR guide: A/C/G/T/N. Default: NN.")
    ...
    parser.add_argument("-w", "--uniqueMethod_Cong", default=True, dest="uniqueMethod_Cong", action="store_true", help="A method to determine how unique the site is in the genome: allows 0 mismatches in last 15 bp.")
    parser.add_argument("-J", "--jsonVisualize", default=False, action="store_true", help="Create files for visualization with json.")
    parser.add_argument("-nonO", "--nonOverlapping", default=True, action="store_true", help="Will not produce overlapping guides, saves time, and recommended for permissive PAMs (e.g. Cas13d).")
    parser.add_argument("-scoringMethod", "--scoringMethod", default="DOENCH_2016", type=str, choices=["XU_2015", "DOENCH_2014", "DOENCH_2016", "MORENO_MATEOS_2015", "CHARI_2015", "G_20", "KIM_2018", "ALKAN_2018", "ZHANG_2019", "ALL"], help="Scoring used for Cas9 and Nickase. Default is G_20. If a method fails to give scores, CHOPCHOP will output 0 instead of terminating.")
    ...
    parser.add_argument("-filterGCmin", "--filterGCmin", default=45, type=int, help="Minimum required GC percentage. Default is 0.")
    parser.add_argument("-filterGCmax", "--filterGCmax", default=80, type=int, help="Maximum allowed GC percentage. Default is 100.")
    ...
    parser.add_argument("-consensusUnion", "--consensusUnion", default=True, action="store_true", help="When calculating consensus sequence from multiple isoforms default uses intersection. This option specifies union of isoforms.")
    ...
    parser.add_argument("-TDP", "--targetDownstreamPromoter", default=2000, type=int,
