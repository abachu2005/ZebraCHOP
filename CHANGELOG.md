...
### Added
- `NOTICE` file with upstream CHOPCHOP + Azimuth attribution.
- `.zenodo.json` for automatic Zenodo archival + DOI minting on every release.

### Fixed
- `LICENSE` now contains only the standard MIT text so GitHub's SPDX
  detector (Licensee) correctly identifies it as MIT. Upstream attribution
  moved to `NOTICE`.
...
[Unreleased]: https://github.com/abachu2005/ZebraCHOP/compare/v1.0.1...HEAD
[1.0.1]: https://github.com/abachu2005/ZebraCHOP/releases/tag/v1.0.1
